...
| `piratebay_top` | World TOP | `https://1.piratebays.to/top/207` | Да |
...
`piratebay_top` парсится отдельным одноуровневым parser'ом: magnet уже есть в listing, а `topic_id` строится из BTIH как `pb_<hash>`.
